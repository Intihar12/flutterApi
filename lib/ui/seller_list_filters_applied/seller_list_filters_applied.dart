...
class FilterSellerListPage extends StatelessWidget {
  FilterSellerListPage({Key? key,}) : super(key: key);
    ...
    return GetBuilder<SellerListController>(
        builder: (sellercontroller) {
          return Scaffold(
              ...
              body: controller.isSellerFilterLoading.value ?
              ...
              Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text("${controller.totalFilter} results found for “Painters",style: TextStyle(color: MyColors.black.withOpacity(0.4)),),
                      ...
                      Expanded(
                        ...
                        itemCount: sellercontroller.serviceSellerModal.data!.company!.length,
                        shrinkWrap: true,
                        scrollDirection: Axis.vertical,
                        itemBuilder: (BuildContext context,int index)
                        {
